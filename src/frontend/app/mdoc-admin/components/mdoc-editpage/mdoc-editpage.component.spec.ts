...
import {MediaDocEditpageComponent} from './mdoc-editpage.component';
...
describe('MediaDocEditpageComponent', () => {
    let component: MediaDocEditpageComponent;
    let fixture: ComponentFixture<MediaDocEditpageComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MediaDocEditpageComponent],
            imports: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MediaDocEditpageComponent);
