...
import {MediaDocAssignJoinFormComponent} from './mdoc-assignjoinform.component';
...
describe('MediaDocAssignJoinFormComponent', () => {
    let component: MediaDocAssignJoinFormComponent;
    let fixture: ComponentFixture<MediaDocAssignJoinFormComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MediaDocAssignJoinFormComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MediaDocAssignJoinFormComponent);
