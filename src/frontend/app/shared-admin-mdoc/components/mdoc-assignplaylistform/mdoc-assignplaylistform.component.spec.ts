...
import {MediaDocAssignPlaylistFormComponent} from './mdoc-assignplaylistform.component';
...
describe('MediaDocAssignPlaylistFormComponent', () => {
    let component: MediaDocAssignPlaylistFormComponent;
    let fixture: ComponentFixture<MediaDocAssignPlaylistFormComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MediaDocAssignPlaylistFormComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MediaDocAssignPlaylistFormComponent);
