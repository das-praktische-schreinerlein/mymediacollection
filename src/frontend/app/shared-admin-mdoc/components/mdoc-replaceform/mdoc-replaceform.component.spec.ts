...
import {MediaDocReplaceFormComponent} from './mdoc-replaceform.component';
...
describe('MediaDocReplaceFormComponent', () => {
    let component: MediaDocReplaceFormComponent;
    let fixture: ComponentFixture<MediaDocReplaceFormComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MediaDocReplaceFormComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MediaDocReplaceFormComponent);
