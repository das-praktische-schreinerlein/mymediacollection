...
import {MediaDocListItemFlatComponent} from './mdoc-list-item-flat.component';
...
describe('MediaDocListItemFlatComponent', () => {
    let component: MediaDocListItemFlatComponent;
    let fixture: ComponentFixture<MediaDocListItemFlatComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MediaDocListItemFlatComponent],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MediaDocListItemFlatComponent);
